         ...
         <Dialog as='div' className='relative z-40' open={toggle} onClose={() => setToggle(false)}>
               <div className='fixed inset-0 w-full overflow-y-auto'>
                  <div className='flex flex-col min-h-full items-center justify-center'>
                     <DialogPanel transition className='w-screen rounded-2xl px-5 lg:px-20 duration-300 ease-out data-[closed]:transform-[scale(95%)] data-[closed]:opacity-0'>        
                        <div className='relative bg-slate-800 rounded-lg'>
                           ...
                           <Box sx={{ display: 'block', justifyContent: 'center', textAlign: 'center', alignItems: 'center', height: '500px', '& .header': { backgroundColor: 'slategray', color: 'ghostwhite', textWrap: 'wrap' } }}>
